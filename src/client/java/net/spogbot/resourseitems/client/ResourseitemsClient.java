...
import net.spogbot.resourseitems.client.scanner.ResourcePackModelScanner;
 ...
 *     в ресурспаках
 *     (см. {@link net.spogbot.resourseitems.client.scanner.handler.ItemModelPreviewHandler});</li>
 *     <li><b>custom_model_data</b> — варианты предметов, переключаемые по
 *     значению компонента custom_model_data
 *     (см. {@link net.spogbot.resourseitems.client.scanner.handler.CustomModelDataVariantHandler});</li>
 *     <li><b>custom_name</b> — варианты предметов, переключаемые по
 *     присвоенному игроком имени (custom_name)
 *     (см. {@link net.spogbot.resourseitems.client.scanner.handler.CustomNameVariantHandler}).</li>
 * </ul>
